                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">Pdf Upload</label>:
                                <input name="pdf" id="drawing_of_assembly" class="form-control" type="file" accept = "application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" <?php echo $disabled ?>>
                              <?php if(isset($_GET['id']) && $pdf!=""){ ?>
                                  <a href="assets/uploads/dcfd_Pdf/<?php echo $pdf; ?>" target="_blank">
                                    <span id="pdfset" class="fa fa-file-pdf"></span>
                                    <a href="assets/uploads/dcfd_Pdf/<?php echo $pdf; ?>" target="_blank"><?php echo $pdf; ?></a>
                                  </a>
                              <?php } ?> 
                          <input type="hidden" name="pdf" value="<?php if($pdf!=""){ echo $pdf;  } ?> " />
                          <input type="hidden" name="id" value="<?php if($_GET['id']!=""){ echo $_GET['id']; } ?> "/>
                          <input type="hidden" name="type" value="DCFD" />
                      </div>
                    </div>
