        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item"> <a class="nav-link border2 <?php echo ($uri=='dashboard') ? 'custom-active': ''; ?>" title="Dashboard" href="dashboard.php"> <i class="nav-icon fas fa-briefcase"></i>
            ...
            <li class="nav-item <?php echo ($uri=='dcfd') ? 'custom-active': ''; ?>"> 
              <a class="nav-link" title="" href="dcfd.php"> <i class="nav-icon fas fa-podcast"></i>
                <p> DCFD </p>
              </a> 
            </li>
            <li class="nav-item <?php echo ($uri=='assembly') ? 'custom-active': ''; ?>"> 
              <a class="nav-link" title="" href="assembly.php"> <i class="nav-icon fas fa-ship"></i>
                <p> SU Numbers </p>
              </a> 
            </li>
            <li class="nav-item <?php echo ($uri=='subsu_assembly') ? 'custom-active': ''; ?>"> 
              <a class="nav-link" title="" href="subsu_assembly.php"> <i class="nav-icon fas fa-ship"></i>
                <p> SubSU Numbers </p>
              </a> 
            </li>
          ...
          <li class="nav-item <?php echo ($uri=='product-management' || $uri=='add-edit-product') ? 'custom-active': ''; ?>"> <a class="nav-link" title="" href="product-management.php"> <i class="nav-icon fas fa-tasks"></i>
            <p> SU Assemblies  </p>
            </a> 
          </li>
          <li class="nav-item <?php echo ($uri=='sub-components' || $uri=='add-edit-subcomponent') ? 'custom-active': ''; ?>"> <a class="nav-link" title="" href="sub-components.php"> <i class="nav-icon fas fa-th-large"></i>
            <p> Sub Components </p>
            </a> </li>
          ...
          <li class="nav-item <?php echo (($uri=='users' || $uri=='add-edit-user') && !isset($_GET['type'])) ? 'custom-active': ''; ?>"> <a class="nav-link" title="" href="./users.php"> <i class="nav-icon fas fa-users-cog"></i>
            <p> Users </p>
            </a> </li>
          <li class="nav-item has-treeview <?php echo ($uri=='add-edit-user' && isset($_GET['type'])) ? 'custom-active': ''; ?>"> <a class="nav-link" title="" href="./add-edit-user.php?id=<?php echo $_SESSION['LOGIN']['user_id']; ?>&type=profile"> <i class="nav-icon fas fa-user"></i>
            <p> My Profile </p>
            </a> </li>
            <li class="nav-item has-treeview <?php echo ($uri=='changepassword') ? 'custom-active': ''; ?>"> <a class="nav-link" title="" href="./changepassword.php"> <i class="nav-icon fas fa-key"></i>
            <p>Change Password</p>
            </a> </li>
          <li class="nav-item has-treeview"> <a class="nav-link" title="" href="./logout.php"> <i class="nav-icon fas fa-sign-out-alt"></i>
            <p> Logout </p>
            </a> </li>

          <?php }else{ ?>
            <li class="nav-item has-treeview"> <a class="nav-link" title="" href="./login.php"> <i class="nav-icon fas fa-sign-out-alt"></i>
            <p> Login </p>
            </a> </li>
          <?php } ?>
