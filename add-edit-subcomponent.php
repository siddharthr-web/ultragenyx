    ...
    <div class="card">
        ...
        <div class="col-md-6">
          ...
          <label class="control-label">Manufacturer</label>: <br>
            <select class="manufacturer_id_fk_sub_component form-control" name="manufacturer_id_fk[]" multiple="multiple" <?php echo $disabled ?>>
              <?php
                  foreach ($allManufacturer as $key => $value) 
                  { 
                    ?>
                    <option 
                    <?php 
                    if (in_array($value['id'],$manufacturerIds))
                    { 
                      echo 'selected'; 
                    } 
     ...
     <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
          <label class="control-label">Equipment</label>: <br>
            <select class="equipment_id_fk_sub_component form-control" name="equipment_id_fk[]" multiple="multiple" <?php echo $disabled ?>>
              <?php
                  foreach ($allEquipment as $key => $value) 
                  { 
                    ?>
                    <option 
                    <?php 
                    if (in_array($value['id'],$equipmentIds))
                    { 
                      echo 'selected'; 
                    } 
                    ?> value="<?php echo $value['id']; ?>"><?php echo $value['name']; ?> </option>
...
<script type="text/javascript">
  ...
  $(".manufacturer_id_fk_sub_component").select2({
    placeholder: "Select Process",
    allowClear: true
  });
  $(".equipment_id_fk_sub_component").select2({
    placeholder: "Select Process",
    allowClear: true
  });
