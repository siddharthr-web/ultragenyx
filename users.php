<?php 
include('header.php');
$allRecords = getAllRecords($connection, 'tbl_user', array('is_active'=> 1), "ORDER BY user_id DESC");
// print_r($_SESSION['toast_list']); die;
?>
                    ...
                    <div class="fixed-table-toolbar" style="position:relative; top:-10px;">
                      ...
                      <div class="columns columns-right btn-group float-right">
                        ...
                        <div class="export btn-group">
                          <a class="btn btn-primary" aria-label="Export" type="button" title="Export data" href= "<?php echo SITE_URL;?>exportdata.php?section=users"> <i class="fa fa-download"></i></a>
                        ...
                        while ($row = $allRecords->fetch_assoc()) { ?>
                          <tr data-index="0" data-uniqueid="2">
                            ...
                            <td style="text-align: center; ">
                              <a style="cursor: pointer;" href="./add-edit-user.php?id=<?php echo $row['user_id']; ?>" title="Edit"> <i class="fa fa-edit"></i> </a>
                              <?php if($row['user_id']!=1 && $row['user_id']!=$_SESSION['LOGIN']['user_id']) { ?>
                               <a 
                              class="pointer t11" 
                              href="<?php echo SITE_URL;?>delete_records.php?id=<?php echo $row['user_id'];?>&type=users" 
                              title="Delete"
