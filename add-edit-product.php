...
// exit;
  ...
  $allDSFD = getAllRecords($connection, 'tbl_dcfd');
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.6/css/selectize.bootstrap3.min.css" integrity="sha256-ze/OEYGcFbPRmvCnrSeKbRTtjG4vGLHXgOqsyLFTRjg=" crossorigin="anonymous" /> -->
			...
			<div class="card-body">
				...
				<div class="col-md-6">
				  <div class="form-group">
					...
					<input type="text" name="name" id="name" class="form-control validate[required]" placeholder="Enter Assembly Name" value="<?php echo $name; ?>" <?php echo $disabled; ?>>            
				  </div>
				</div>
				<div class="col-md-6">
				  <div class="form-group">
					<label class="control-label">Internal Part No</label>:
					<input type="text" name="internal_part_no" id="internal_part_no" class="form-control" placeholder="Enter Internal Part No"  value="<?php echo $internal_part_no; ?>" <?php echo $disabled; ?>>            
				  </div>
				</div>
			  </div>
			  <div class="row">
				<div class="col-md-6">
				  <div class="form-group">
					<label class="control-label">Upload Drawing of Assembly</label>:
					          <input name="drawing_of_assembly" id="drawing_of_assembly" class="form-control" type="file" value="<?php //echo ; ?>" onchange="checkfile(this,'photo');" <?php echo $disabled; ?>>
					        <?php if(isset($_GET['id']) && $drawing_of_assembly!=""){ ?>
                    	<a  href="./assets/uploads/drawing-assembly/<?php echo $drawing_of_assembly; ?>" target="_blank"><img src="./assets/uploads/drawing-assembly/<?php echo $drawing_of_assembly; ?>" height="80" style="margin-top:10px;"></a>
                	<?php } ?>
				  </div>
				</div>
				<div class="col-md-6">
       ...
       <div class="row">
        <div class="col-md-6">
          <div class="form-group">
                ...
                <input name="intended_use_description" id="intended_use_description" class="form-control" type="text" value="<?php echo $intended_use_description; ?>"  placeholder="Intended Use Description" <?php echo $disabled; ?>>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input name="batch_record" id="batch_record" class="form-control" type="text" placeholder="Enter Batch Record" value="<?php echo $batch_record; ?>" <?php echo $disabled; ?>>           
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
              <label class="control-label">DCFD</label>: <br>
                <select class="dcfd_id_fk_product form-control" name="dcfd_id_fk[]" multiple="multiple" <?php echo $disabled ?>>
                  <?php
                      foreach ($allDSFD as $key => $value) 
                      { 
                        ?>
                        <option 
                        <?php 
                        if (in_array($value['id'],$materialIds))
                        { 
                          echo 'selected'; 
                        } 
           ...
           <!--  <div class="col-md-6">
                <div class="form-group">
                 ...
                 <div class="selectBox" 
                    ...
                    <select class="form-control" <?php echo $disabled; ?>> 
                        <option><?php 
                          if(isset($selectedDCFDString))
                          { 
                              echo $selectedDCFDString; 
                          } 
                          else 
                          { 
                ...
                <div id="checkBoxes1"> 
                    <?php 
                        $i=1; 
                        foreach ($allDSFD as $value) { ?>
                          <label for="dcfd_<?php echo $i; ?>"> 
                              <input  class="alldsfc" type="checkbox" name="dcfd_id_fk[]" id="dcfd_<?php echo $i; ?>" value="<?php echo $value['id']; ?>" <?php echo in_array($value['id'], $dcfdIds) ? "checked" : ""; ?>/> 
                              <?php echo $value['name']; ?> 
                          </label> 
                      <?php $i++; } ?>
                </div>    
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="su_assembly" id="su_assembly" class="form-control su_assembly" <?php echo $disabled; ?>>
              ...
              <div class="row">
                ...
                <!-- <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div id="checkBoxes" <?php echo $disabled; ?>>                 
                      <?php 
                          $i=1; 
                ...
                <div class="col-md-6">
                      ...
                      <label class="control-label">Material</label>: <br>
                        <select class="product_material_id_fk form-control" name="material_id_fk[]" multiple="multiple" <?php echo $disabled ?>>
                          <?php
                ...
                <div class="col-md-6">
                  ...
                  <select name="manufacturer_id" id="manufacturer_id" class="form-control validate[required] manufacturer_id" <?php echo $disabled; ?>>
                    <option value="">Select Manufacturer</option>
                        <?php
                              foreach ($allManufacturer as $value) 
                              { ?>
                                <option value=<?php echo $value['id']; ?>  <?=$value['id'] == $manufacturer_id ? ' selected="selected"' : '';?>><?php echo $value['name']; ?></option>
                        <?php } ?>
                    </select>
                  </div>
                </div>
  ...
  <div class="card">
    ...
    <!-- Bootstrap 3 table -->
      <div class="card-body">
          <div class="row">
            <textarea name="other_details" id="other_details" cols="150" rows="5" <?php echo $disabled; ?>><?php echo $other_details; ?></textarea>
        </div>
    </div>
  </div>
...
{
  $(".dcfd_id_fk_product").select2({
    placeholder: "Select Process",
    allowClear: true
  });
  $(".product_material_id_fk").select2({
    placeholder: "Select Process",
    allowClear: true
  });
      ...
      var dcfd_ids = [];
      $.each($("input[name='dcfd_id_fk[]']:checked"), function(){
        dcfd_ids.push($(this).val());
      });
      
       $.ajax({
            url:"insert-update.php",  
            type: "post", 
            data: {dcfd_ids: dcfd_ids,su_assembly_id : su_assembly_id, type: "onchange_dcfd"},
    ...
    $(document).on("click",".alldsfc",function(){
         var dcfd_ids = [];
          $.each($("input[name='dcfd_id_fk[]']:checked"), function(){
            dcfd_ids.push($(this).val());
          });
         $.ajax({
            url:"insert-update.php",  
            type: "post", 
            data: {dcfd_ids: dcfd_ids, type: "onchange_dcfd"},
            success:function(result)
            {
                $(".su_assembly").html("");
                $(".su_assembly").html(result);
