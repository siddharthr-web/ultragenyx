        ...
        {  
            ...
            ?>
                <div class="remove_<?php echo $i;  ?>">
                        <span>SU Number</span>
                        <select style="width:50%" data-id=<?php echo $i; ?> name='sub_component_id[]' id="subcomp_<?php echo $sub_component_id_fk[$i]; ?>" class="form-control sub_component_id_onchange" placeholder="Select Sub Component" <?php echo $disabled ?>>
                            <option value=""></option>
                            <?php 
