       ...
       <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input name="batch_record" id="batch_record" class="form-control" type="text" placeholder="Enter Critical Functional Single Use Part Attributes." value="<?php echo $batch_record; ?>" <?php echo $disabled; ?>>           
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
