			...
			<div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input name="sub_copoment_name" id="sub_copoment_name" class=" form-control validate[required]" type="text" placeholder="Enter Sub Component Name"  value="<?php echo $sub_copoment_name; ?>" />            
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
			  ...
			  <div class="row">
				<div class="col-md-6">
				  <div class="form-group">
					...
					<input name="drawing_of_sub_component" id="drawing_of_sub_component" class="fordrawing_of_sub_componentm-control" type="file" onchange="checkfile(this,'photo');" /> 
                        <?php if(isset($_GET['id']) && $drawing_of_sub_component!=""){ ?>
                            <a href="./assets/uploads/drawing-sub-component/<?php echo $drawing_of_sub_component; ?>" target="_blank">
                                <img style="margin-top:10px;" src="./assets/uploads/drawing-sub-component/<?php echo $drawing_of_sub_component; ?>" width="40%" height="80"></a>
                        <?php } ?>          
				  </div>
				</div>
				<div class="col-md-6">
          ...
          <div class="selectBox" 
            ...
            <div id="checkBoxes1"> 
                    ...
                    <label for="manufacturer_<?php echo $i; ?>"> 
                        <input type="checkbox" name="manufacturer_id_fk[]" id="manufacturer_<?php echo $i; ?>" value="<?php echo $value['id']; ?>" <?php echo in_array($value['id'], $manufacturerIds) ? "checked" : ""; ?>/> 
                        <?php echo $value['name']; ?> 
                    </label> 
                 <?php $i++; } ?>
                </div>           
...
<div class="card">
    ...
    <!-- Bootstrap 3 table -->
      <div class="card-body">
          <div class="row">
            <textarea cols="150" rows="5" name="other_details" id="other_details"><?php echo $other_details; ?></textarea>
        </div>
    </div>
